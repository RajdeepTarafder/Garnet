...
TEST_DATA_OPTION = ['Mantle vs Crust Data', 'Data For Provanace Classification','Data For Metamorphic Group']
...
MISS_VALUES =['Missing Values','<0.03','NA','-0.01']
IMPUTING_STRATEGY = ['Mean', 'Median', 'Most Frequent','KNN_Imputer']
FEATURE_ENGINEERING = ['OXIDE','CATION','CATION NO','Not required']
LABEL_COMP=['A','CS','IF','M','S','UM']
LABEL_PROV=['AM','BS','GS','EC/UHP','GR','IG','MA','MS']
LABEL_CM=['CRUST','MANTLE']