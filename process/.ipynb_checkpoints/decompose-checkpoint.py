...
class DecompositionModelSelection(object):
    ...
    def activate(self, X: pd.DataFrame,y:Optional[pd.DataFrame] = None,LABEL_1: Optional[List[str]] = None) -> None:
        ...
        self.dcp_workflow.special_components(LABEL_1,components_num=self.components_num, reduced_data=X_reduced)
