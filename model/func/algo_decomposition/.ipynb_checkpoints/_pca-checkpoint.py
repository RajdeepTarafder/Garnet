...
from model.decomposition import DecompositionWorkflowBase
from typing import Optional, List


def biplot(reduced_data: pd.DataFrame, pc: pd.DataFrame, algorithm_name: str,store_path: str) -> None:
    ...
    """
    labels=np.array(DecompositionWorkflowBase().y)
    ...
    if labels:
        ...
        for i, label in enumerate(classes):
            #sns.scatterplot(data=df, hue="label_co", style="label_co")
...
def triplot(labels,reduced_data: pd.DataFrame, pc: pd.DataFrame, algorithm_name: str,
            store_path: str) -> None:
